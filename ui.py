...
# Set up DeepSeek API client via OpenRouter
client = OpenAI(
    base_url="https://openrouter.ai/api/v1",
    api_key="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",  # Replace with your API key
    timeout=60
)
...
- **If Health or Finance:**  
  ...
  - **Suggested Corrections (if applicable)**  
        ...
        try:
            ...
            st.error("🚫 Rate limit exceeded. Please wait or upgrade your OpenRouter plan.")
            response = None
        ...
        if response:
            ...
            try:
                ...
                st.warning("⚠️ Could not parse some fields from the response.")
            ...
            try:
                ...
                st.warning("🔊 Could not convert text to speech.")
